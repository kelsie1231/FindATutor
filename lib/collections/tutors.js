...
validateTutorCourseInfo = function(courseInfo){
  var errors = {};

  $.each(courseInfo, function(key,value){ //loop through the array

      errors['#tutor-course-number'+value.order] = value.courseNumber ? false:true;
      errors['#tutor-course-title'+value.order] = value.courseTitle ? false:true;
  });
  return errors;
}
